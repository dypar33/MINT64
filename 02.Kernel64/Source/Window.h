...
#define WINDOW_COLOR_FRAME RGB(146, 184, 177)
#define WINDOW_COLOR_BACKGROUND RGB(255, 255, 255)
#define WINDOW_COLOR_TITLEBARTEXT RGB(0, 0, 0)
#define WINDOW_COLOR_TITLEBARACTIVEBACKGROUND RGB(92, 255, 209)
#define WINDOW_COLOR_TITLEBARINACTIVEBACKGROUND RGB(140, 189, 184)
#define WINDOW_COLOR_TITLEBARBRIGHT1 RGB(140, 189, 184)
#define WINDOW_COLOR_TITLEBARBRIGHT2 RGB(148, 176, 183)
...
#define WINDOW_COLOR_XBUTTONLINECOLOR RGB(148, 176, 183)
...
#define MOUSE_CURSOR_OUTER RGB(92, 255, 209)
