...
{
    if((iX < pstArea->iX1) || (iX > pstArea->iX2) || (iY < pstArea->iY1) || (iY > pstArea->iY2))
        return FALSE;
...
{
    int iMaxX1, iMinX2, iMaxY1, iMinY2;
...
{
    int iDeltaX, iDeltaY, iX, iY, iDeltaError, iStepX, iStepY;
    int iError = 0;
...
{
    int iWidth, iTemp, iY, iMemoryAreaWidth;
    VBEMODEINFOBLOCK* pstModeInfo;
    RECT stDrawRect, stOverlappedArea;
...
{
    int iCircleX, iCircleY, iDistance;
...
{
    int iCurrentX, iCurrentY, i, j, k, iBitmapStartIndex, iMemoryAreaWidth, iStartXOffset, iStartYOffset, iOverlappedWidth, iOverlappedHeight;
    BYTE bBitmap, bCurrentBitmask;
