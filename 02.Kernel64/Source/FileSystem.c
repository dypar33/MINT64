...
BOOL kMount(void)
{
    ...
    gs_stFileSystemManager.dwClusterLinkAreaStartAddress = pstMBR->dwReversedSectorCount + 1;
    gs_stFileSystemManager.dwClusterLinkAreaSize = pstMBR->dwClusterLinkSectorCount;
    gs_stFileSystemManager.dwDataAreaStartAddress = pstMBR->dwReversedSectorCount + pstMBR->dwClusterLinkSectorCount + 1;
...
BOOL kFormat(void)
{
    ...
    pstMBR->dwReversedSectorCount = 0;
