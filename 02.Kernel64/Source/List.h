...
struct kListItemExcampleStruct
{
    LISTLINK stLink;
...
void* kRemoveList(LIST* pstLst, QWORD qwID);
void* kRemoveListFromHeader(LIST* pstLst);
void* kRemoveListFromTail(LIST* pstLst);
void* kFindList(const LIST* pstLst, QWORD qwID);
