...
int Main(char *pcArgument)
{
    ...
    {
        printf("usage) exec textviewer.elf a.txt\n");
        return 0;
    }
...
BOOL DrawTextBuffer(QWORD qwWindowID, TEXTINFO *pstInfo)
{
    ...
    DrawText(qwWindowID, (iWidth - iLength * FONT_ENGLISHWIDTH) / 2, WINDOW_TITLEBAR_HEIGHT + 2, RGB(255, 255, 255), RGB(55, 215, 47), vcBuffer, strlen(vcBuffer));
